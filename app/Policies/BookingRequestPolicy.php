...
class BookingRequestPolicy
{
    ...
    {
        return $user->id === $bookingRequest->seeker_id || $user->id === $bookingRequest->property->lister_id;
    }
    ...
    {
        return $user->id === $bookingRequest->property->lister_id;
    }
    ...
    {
        return $user->id === $bookingRequest->seeker_id && $bookingRequest->status === 'pending';
    }
